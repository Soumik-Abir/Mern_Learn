...
const Banner = () => {
  return (
    <div className="banner w-full md:w-2/3 px-3 mx-auto relative flex items-center-justify-between">
      <div className="banner-deescription w-full md:w-1/2 p-4 mt-16">
